...
try:        
    ...
    #개별 종목 데이터
    symbol_list = {
    '069500':{'종목명':'코스피_200 #1', #1
    '예산_가중치':1.35,
    '익절_가중치':0.65,
    **common_data},
    '114800':{'종목명':'코스피_인버스 #2', #2
    '예산_가중치':1.35,
    '익절_가중치':0.65,
    **common_data},
    '122630':{'종목명':'코스피_레버리지 #3', #3
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},
    '252670':{'종목명':'코스피_인버스X2 #4', #4
    '예산_가중치':1,
    '익절_가중치':1,
    **common_data},

    '229200':{'종목명':'KOSDAQ_150 #5', #5
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},
    '233740':{'종목명':'KOSDAQ_레버리지 #6', #6
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},
    '251340':{'종목명':'KOSDAQ_인버스X2 #7', #7
    '예산_가중치':1,
    '익절_가중치':1,
    **common_data},

    '102110':{'종목명':'TIGER_200 #8', #8
    '예산_가중치':1.35,
    '익절_가중치':0.65,
    **common_data},
    '396500':{'종목명':'TIGER_반도체TOP10 #9', #9
    '예산_가중치':1,
    '익절_가중치':1,
    **common_data},
    '371460':{'종목명':'TIGER_차이나 #10', #10
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},  

    '462330':{'종목명':'코스피_2차전지레버 #11', #11
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},    
    '465350':{'종목명':'KB_2차전지_인버스 #12', #12
    '예산_가중치':1,
    '익절_가중치':1,
    **common_data},

    '471760':{'종목명':'TIGER_AI반도체공정 #13', #13
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},       
    '471990':{'종목명':'코스피_AI반도체장비 #14', #14
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},                        
    }
