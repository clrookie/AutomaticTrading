...
try:        
    ...
    **common_data},
    ...
    '102110':{'종목명':'TIGER_200', #8
    '예산_가중치':1.35,
    '익절_가중치':0.65,
    **common_data},
    '396500':{'종목명':'TIGER_반도체TOP10', #9
    '예산_가중치':1,
    '익절_가중치':1,
    **common_data},
    '371460':{'종목명':'TIGER_차이나', #10
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},  

    '462330':{'종목명':'코스피_2차전지레버', #11
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},    
    '465350':{'종목명':'KB_2차전지_인버스', #12
    '예산_가중치':1,
    '익절_가중치':1,
    **common_data},

    '471760':{'종목명':'TIGER_AI반도체공정', #13
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},       
    '471990':{'종목명':'코스피_AI반도체장비', #14
    '예산_가중치':1,
    '익절_가중치':1.25,
    **common_data},                        
    }
